...
def parse_xml(args):
    ...
    annotation = {
        'filename': img_path.replace('PreviewData.jpeg', 'RGB.jpg'),
        'filename_thermal': img_path,
        'width': w,
        'height': h,
        'ann': {
...
def cvt_annotations(devkit_path, split, out_file):
    ...
    img_paths = [
        f'JPEGImages/{img_name}.jpeg' for img_name in img_names
    ]
...
def cvt_to_coco_json(annotations):
    ...
    for ann_dict in annotations:
        ...
        file_name_thermal = ann_dict['filename_thermal']
        ann = ann_dict['ann']
        assert file_name not in image_set
        image_item = dict()
        image_item['id'] = int(image_id)
        image_item['file_name'] = str(file_name)
        image_item['file_name_thermal'] = str(file_name_thermal)
