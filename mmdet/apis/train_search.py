...
from .mmcv_custom.runner import EpochBasedRunnerSearch
...
def train_detector_search(model,
                   dataset,
                   cfg,
                   distributed=False,
                   validate=False,
    ...
    runner_type = 'EpochBasedRunnerSearch' if 'runner' not in cfg else cfg.runner[
        'type']
    ...
    if distributed:
        if isinstance(runner, EpochBasedRunnerSearch):
