...
class FLIRDataset(CustomDataset):
    ...
    def __init__(self,
        ...
        self.vis_and_thermal = vis_and_thermal
    ...
    def load_annotations(self, ann_file):
        ...
        for i in self.img_ids:
            ...
            if self.thermal:
                info['filename'] = info['file_name_thermal']
            else:
                info['filename'] = info['file_name']
            # info['filename'] = info['file_name_thermal']
            info['filename_thermal'] = info['file_name_thermal']
    ...
    def evaluate_ap(self,
        ...
        result_files, tmp_dir = self.format_results(results, jsonfile_prefix)
        eval_results, ap = self.evaluate_det_segm(results, result_files, coco_gt,
                                              metrics, logger, classwise,
                                              proposal_nums, iou_thrs,
                                              metric_items)
