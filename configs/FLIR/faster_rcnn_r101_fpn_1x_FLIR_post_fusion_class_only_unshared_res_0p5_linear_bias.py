...
model = dict(
    ...
    init_cfg=dict(type='Pretrained', checkpoint='/data0/linzhiwei/pretrain_ckpt/faster_rcnn_r101_fpn_1x_FLIR_double_coco_pretrain_shared.pth'),
    roi_head=dict(
