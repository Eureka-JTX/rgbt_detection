_base_ = [
    '../_base_/models/faster_rcnn_detnas_fpn.py', '../_base_/datasets/FLIR_double.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        arch=(3, 3, 3, 1, 1, 0, 3, 1, 2, 2, 0, 3, 1, 0, 0, 3, 2, 2, 1, 0)
    ),
    ...
    roi_head=dict(
        type='PostFusionClassUnsharedRoIHead',
...
# runtime settings
runner = dict(type='EpochBasedRunner',max_epochs=24)  # actual epoch = 4 * 3 = 12
